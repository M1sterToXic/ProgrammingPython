...
window = sg.Window('Второе окно', layout, background_color='#196c4f', element_justification='center')
...
while True:
    ...
    if event == 'start':
        ...
        rounds_limit = values.get("-RAUNDS-")
        if rounds_limit.isdigit():
            rounds_limit = int(rounds_limit)
        elif rounds_limit.isalpha():
